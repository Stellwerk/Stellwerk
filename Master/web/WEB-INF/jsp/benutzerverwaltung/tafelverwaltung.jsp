...
<div id="content" class="table">
    ...
    <h2>Tafelverwaltung</h2>     
     <p>Derzeit sind insgesamt <b>${tafelanzahl}</b> Tafeln registriert.</p>
    <table>
        <thead>
            <tr>
                <td>ID</td>
        ...
        <tbody>
            ...
            <c:forEach items="${liste}" var="element" varStatus="line" >
                ...
                <tr class="${rowColor}">
                    <td>${element.id}</td>
                    <td><a href="<%=request.getContextPath()%>/tafelverwaltung/${element.id}/tafel-details">${element.tafelname}</a></td>
                    ...
                    <td><a href="<%=request.getContextPath()%>/tafelverwaltung/${element.id}/tafel-details">Details &raquo;</a></td>
                </tr>
            </c:forEach>
    ...
    <hr />
    <div class="buttons">
        <a href="<%=request.getContextPath()%>/tafelverwaltung/tafel/hinzufuegen" class="button" title="Tafel hinzuf&uuml;gen &raquo;">Tafel hinzuf&uuml;gen &raquo;</a>
        <div class="clear"></div>
    </div>
</div>
