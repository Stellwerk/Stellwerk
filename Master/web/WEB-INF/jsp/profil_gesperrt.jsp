...
<form:form action="/mein-profil" method="POST" commandName="Profil">
    ...
    <div id="content">
        ...
        <ul>
            ...
            <li>
                ...
                <form:input path="benutzer.vorname" cssClass="field" disabled="true" />
                <dl class="info">
                    <dt>&#x69;</dt>
            ...
            <li>
                ...
                <form:input path="benutzer.nachname" cssClass="field" disabled="true" />
            </li>
            <li>
                <form:label path="benutzer.eMail">E-Mail *</form:label>
                <form:input path="benutzer.eMail" cssClass="field" disabled="true" />
            </li>
        </ul>
        <sec:authorize access="hasAnyRole('ROLE_SPENDER', 'ROLE_TAFEL', 'ROLE_KOORD')">
            ...
            <sec:authorize access="hasAnyRole('ROLE_SPENDER')">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <form:input path="spender.firmenname" cssClass="field" disabled="true"  />
                    </li>
                    <li>
                        <form:label path="spender.oeffnungszeiten">&Ouml;ffnungszeiten</form:label>
                        <form:input path="spender.oeffnungszeiten" cssClass="field" disabled="true" />
                    </li>
                    <li>
                        <form:label path="spender.sicherheitsbestimmungen">Sicherheitsbestimmungen</form:label>
                        <form:input path="spender.sicherheitsbestimmungen" cssClass="field" disabled="true" />
                    </li>
                </ul>
            </sec:authorize>
            ...
            <c:if test ="${Profil.rolle=='Tafel' || Profil.rolle=='TafelKoord'}">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <form:input path="tafel.tafelname" cssClass="field" disabled="true" />
                        <dl class="info">
                            <dt>&#x69;</dt>
                    ...
                    <li>
                        ...
                        <form:input path="tafel.oeffnungszeiten" cssClass="field" disabled="true" />
                    </li>
                    <li>
                        <form:label path="tafel.transporter">Transporter</form:label>
                        <form:input path="tafel.transporter" cssClass="field" disabled="true" />
                    </li>
                </ul>
            ...
            <c:if test ="${Profil.rolle=='Tafel' || Profil.rolle=='TafelKoord' || Profil.rolle == 'Spender'}">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <form:input path="adresse.beschreibung" cssClass="field" disabled="true" />
                    </li>
                    <li>
                        <form:label path="adresse.strasse">Stra&szlig;e * / Nr. *</form:label>
                        <form:input path="adresse.strasse" cssClass="field" disabled="true" />
                    </li>

                    <li>
                        <form:label path="adresse.plz">PLZ *</form:label>
                        <form:input path="adresse.plz" cssClass="field" disabled="true" />
                    </li>

                    <li>
                        <form:label path="adresse.ort">Ort *</form:label>
                        <form:input path="adresse.ort" cssClass="field" disabled="true" />
                    </li>
                    </ul>
                ...
                <c:if test ="${Profil.rolle=='Tafel' || Profil.rolle=='TafelKoord' || Profil.rolle == 'Spender'}">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <form:input path="kontakt.eMail" cssClass="field" disabled="true" />
                        </li>
                        <li>
                            <form:label path="kontakt.vorname">Vorname *</form:label>
                            <form:input path="kontakt.vorname" cssClass="field" disabled="true" />
                        </li>
                        <li>
                            <form:label path="kontakt.nachname">Nachname *</form:label>
                            <form:input path="kontakt.nachname" cssClass="field" disabled="true" />
                        </li>
                        <li>
                            <form:label path="kontakt.telefon">Telefon</form:label>
                            <form:input path="kontakt.telefon" cssClass="field" type ="tel" disabled="true" />
                        </li>
                        <li>
                            <form:label path="kontakt.fax">Fax</form:label>
                            <form:input path="kontakt.fax" cssClass="field" type="tel" disabled="true" />
                        </li>
                    </ul>
                </c:if> 
            ...
            <ul>
                ...
                <li>
                    ...
                    <form:input path="neuesPasswort" cssClass="field" type="password" disabled="true" />
                </li>
                <li>
                    <form:label path="bestNeuesPasswort">Passwort wiederholen</form:label>
                    <form:input path="bestNeuesPasswort" cssClass="field" type="password" disabled="true" />
                </li>
            </ul>
            <hr>
            <ul>
                ...
                <li>
                    ...
                    <form:input path="passwortkontrolle" cssClass="field" type="password"  disabled="true" />
                    <dl class="info">
                        <dt>&#x69;</dt>
            ...
            <div class="buttons">
                ...
                <input type="submit" value="Aktualisieren &raquo;" class="button"  disabled="true" /> 
                <div class="clear"></div>   
            </div>
    </div>
</form:form>
